...
#region = 'us-west-2'
endpoint = "http://ec2-34-224-65-150.compute-1.amazonaws.com"
...
request_parameters =  "{'Access':'Granted'}"
...
def send_message():
    ...
    r = requests.get(f"{endpoint}/api/gps/add?user=user1&&device=device1&&lon=test&&lat=facial")
